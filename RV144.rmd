...
```
  ...
  We now test the independence of the aids vaccine and placebo group using the chi-square test.  We will state the null and alternative hypotheses for this test.  
...
$H_0:$ The odds ratio between contracting aids and having the vaccine contains the number 1.  

$H_A:$ The odds ratio between contracting aids and having the vaccine does not contain the number 1.
